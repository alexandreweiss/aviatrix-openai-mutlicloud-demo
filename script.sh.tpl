...
runcmd:
  ...
  - sed -i "s/^AZURE_OPENAI_MODEL=.*/AZURE_OPENAI_MODEL=${azure_openai_model}/" /home/ubuntu/sample-app-aoai-chatGPT/.env
  - sed -i "s/^AZURE_OPENAI_KEY=.*/AZURE_OPENAI_KEY=${azure_openai_key}/" /home/ubuntu/sample-app-aoai-chatGPT/.env
  - sed -i "s/^AZURE_OPENAI_MODEL_NAME=.*/AZURE_OPENAI_MODEL=${azure_openai_deployment_name}/" /home/ubuntu/sample-app-aoai-chatGPT/.env
  - sed -i "s#^AZURE_OPENAI_ENDPOINT=.*#AZURE_OPENAI_ENDPOINT=${azure_openai_endpoint}#" /home/ubuntu/sample-app-aoai-chatGPT/.env
  - sed -i "s/^AZURE_SEARCH_SERVICE=.*/AZURE_OPENAI_SEARCH_SERVICE=${azure_search_service}/" /home/ubuntu/sample-app-aoai-chatGPT/.env
  - sed -i "s/^AZURE_SEARCH_INDEX=.*/AZURE_OPENAI_SEARCH_INDEX=${azure_search_index}/" /home/ubuntu/sample-app-aoai-chatGPT/.env
